...
class PresentationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create presentation" do
    assert_difference('Presentation.count') do
      post presentations_url, params: { presentation: { markdown: @presentation.markdown, private: @presentation.private, published: @presentation.published, title: @presentation.title, user_id: @presentation.user_id, views: @presentation.views } }
    end
  ...
  test "should update presentation" do
    patch presentation_url(@presentation), params: { presentation: { markdown: @presentation.markdown, private: @presentation.private, published: @presentation.published, title: @presentation.title, user_id: @presentation.user_id, views: @presentation.views } }
